  ...
  return (
    <div className='lgl:w-[35%] w-full h-full bg-gradient-to-r from-[#1e2024] to-[#20272b] lgl:p-8
            ...
            <div className='flex flex-col lgl:gap-4 gap-2'>
              <h3 className='text-3xl font-bold text-white'>Abhay Raj Singh</h3>
              ...
              <p className='text-base text-gray-400 flex  items-center gap-2'>
                Phone: <span className='text-designColor'>+918081192413</span>
              </p>
              <p className='text-base text-gray-400 flex  items-center gap-2'>
                Email: <span className='text-designColor'>abraj.singh743@gmail.com</span>
              </p>
            </div>
