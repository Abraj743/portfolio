...
const Leftbanner = () => {
  ...
  const [text] = useTypewriter({
    words: ['Programmer..', 'Full Stack Developer..', 'MERN Developer..','Software Developer..'],
    loop: true,
    deleteSpeed: 10,
    delaySpeed: 2000,
  })
    ...
    <div className='w-full lg:w-1/2 flex flex-col gap-20'>
        <div className='flex flex-col gap-5'>
          ...
          <h2 className=' text-4xl mdl:text-5xl font-bold text-white'>Hi, I'm{" "}
            <span className='text-designColor capitalize'>Abhay Raj Singh</span></h2>
          <h2 className='text-2xl mdl:text-3xl text-white  font-bold'>a <span style={{color:"#008080"}}>{text}</span>
            <Cursor
        ...
        <div className='flex flex-col lg:flex-row justify-between gap-6 lg:gap-0'>
          <div>
            ...
            <div className='flex gap-4'>
              <span className='bannerIcon'> <a href="https://www.facebook.com/profile.php?id=100094388680722"> <FaFacebookF /></a> </span>
              <span className='bannerIcon'> <a href="https://www.instagram.com/iitian_abhay/"> <FaInstagram /> </a></span>
              <span className='bannerIcon'> <a href="https://www.linkedin.com/in/abhay-raj-singh-57056a218/"> <FaLinkedinIn /></a> </span>
            </div>
          </div>
          <div>
