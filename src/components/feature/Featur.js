...
const Feature = () => {
  return (
    ...
    <div className='grid grid-cols-1 mdl:grid-cols-2 xl:grid-cols-3 gap-8 xl:gap-20'>
      ...
      HTML, CSS, JavaScript, React.js, Redux, Express.js, Node.js,Tailwind CSS,Mongo DB,Cloudinary."
      icon={<CgWebsite/>}
      />
      <Card
      ...
      .I had solved more than 700 problems on Data Structure and Algorithms on various platform like LeetCode,GFG,Coding Ninja and Codeforces"
      icon={<CgCodeSlash/>}/>
      <Card
      title="UI/UX Design"
      ...
      . For deployment there are various plateforms that I use like Heroku, Vercel, Netlify, Hostinger, and many more."
