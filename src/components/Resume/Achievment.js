    ...
    <motion.div initial={{opacity:0}} animate={{opacity:1,transition:{duration:.6}}} className="w-full flex flex-col lg:flex-row  gap-20">
      <div>
        ...
        <div className="mt-4 lg:mt-14 h-auto w-full border-l-[6px] border-l-black border-opacity-30
          ...
          />
          <ResumeCard
            title="Solved 600+ problems on Leetcode"
            subTitle="Lorem ipsum dolor sit amet alternative."
            result="600+"
            des="Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora itaque accusamus corporis dolor debitis natus sapiente, voluptates possimus minima totam!"
          />
          <ResumeCard
            title="Serve as Media  Manager in Club of Sunstainability and Innovation in IIT BHU"
            subTitle="Lorem ipsum dolor sit amet alternative."
            result="Success"
            des="Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora itaque accusamus corporis dolor debitis natus sapiente, voluptates possimus minima totam!"
          />
      ...
      <div>
        ...
        <div className="mt-4 lg:mt-14 h-auto w-full border-l-[6px] border-l-black border-opacity-30
                    flex flex-col gap-4 lg:gap-10">
          <ResumeCard
            title="Gold medal in Carrom in 10th Class"
            subTitle="Lorem ipsum dolor sit amet alternative."
            result="Silver"
            des="Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora itaque accusamus corporis dolor debitis natus sapiente, voluptates possimus minima totam!"
          />
          <ResumeCard
            title="Gold Medal in Cricket in 10th Class"
            subTitle="Lorem ipsum dolor sit amet alternative."
            result="Success"
            des="Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora itaque accusamus corporis dolor debitis natus sapiente, voluptates possimus minima totam!"
          />
